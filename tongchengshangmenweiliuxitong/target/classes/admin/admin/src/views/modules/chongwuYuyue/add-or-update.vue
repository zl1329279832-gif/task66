        ...
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='chongwu'">
                    <el-form-item class="select" v-if="type!='info'"  label="宠物" prop="chongwuId">
                        <el-select v-model="ruleForm.chongwuId" :disabled="ro.chongwuId" filterable placeholder="请选择宠物" @change="chongwuChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='chongwu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="宠物编号" prop="chongwuUuidNumber">
                        <el-input v-model="chongwuForm.chongwuUuidNumber"
                                  placeholder="宠物编号" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="宠物编号" prop="chongwuUuidNumber">
                ...
                <el-col :span="12"  v-if="sessionTable !='chongwu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="宠物地点" prop="chongwuAddress">
                        <el-input v-model="chongwuForm.chongwuAddress"
                                  placeholder="宠物地点" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="宠物地点" prop="chongwuAddress">
                            <el-input v-model="ruleForm.chongwuAddress"
                                      placeholder="宠物地点" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='chongwu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="赞" prop="zanNumber">
                        <el-input v-model="chongwuForm.zanNumber"
                ...
                <el-col :span="12"  v-if="sessionTable !='chongwu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="踩" prop="caiNumber">
                        <el-input v-model="chongwuForm.caiNumber"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="报名编号" prop="chongwuYuyueUuidNumber">
                       <el-input v-model="ruleForm.chongwuYuyueUuidNumber"
                                 placeholder="报名编号" clearable  :readonly="ro.chongwuYuyueUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="报名编号" prop="chongwuYuyueUuidNumber">
                           <el-input v-model="ruleForm.chongwuYuyueUuidNumber"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="报名理由" prop="chongwuYuyueText">
                        <el-input type="textarea"  :readonly="ro.chongwuYuyueText" v-model="ruleForm.chongwuYuyueText" placeholder="报名理由"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.chongwuYuyueText" label="报名理由" prop="chongwuYuyueText">
                            <span v-html="ruleForm.chongwuYuyueText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.chongwuYuyueYesnoTypes" label="报名状态" prop="chongwuYuyueYesnoTypes">
                        <el-input v-model="ruleForm.chongwuYuyueYesnoValue" placeholder="报名状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.chongwuYuyueYesnoText" label="审核回复" prop="chongwuYuyueYesnoText">
                        <span v-html="ruleForm.chongwuYuyueYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.chongwuYuyueShenheTime" label="审核时间" prop="chongwuYuyueShenheTime">
                        <span v-html="ruleForm.chongwuYuyueShenheTime"></span>
                    </el-form-item>
                </div>
            </el-col>
                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.chongwuYuyueTime"  class="input" label="预约时间" prop="chongwuYuyueTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.chongwuYuyueTime"
                                type="datetime"
                                placeholder="预约时间"
                                :disabled="ro.chongwuYuyueTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.chongwuYuyueTime" label="预约时间" prop="chongwuYuyueTime">
                            <span v-html="ruleForm.chongwuYuyueTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
    ...
    export default {
        data() {
            return {
                ...
                yonghuForm: {},
                ro:{
                    chongwuYuyueUuidNumber: false,
                    chongwuId: false,
                    yonghuId: false,
                    chongwuYuyueText: false,
                    chongwuYuyueYesnoTypes: false,
                    chongwuYuyueYesnoText: false,
                    chongwuYuyueShenheTime: false,
                    chongwuYuyueTime: false,
                    insertTime: false,
                },
                ruleForm: {
                    ...
                    yonghuId: '',
                    chongwuYuyueText: '',
                    chongwuYuyueYesnoTypes: '',
                    chongwuYuyueYesnoText: '',
                    chongwuYuyueShenheTime: '',
                    chongwuYuyueTime: '',
                    insertTime: '',
                },
                chongwuYuyueYesnoTypesOptions : [],
                chongwuOptions : [],
                yonghuOptions : [],
                rules: {
                   chongwuYuyueUuidNumber: [
                   ...
                   insertTime: [
                              { required: true, message: '宠物报名时间不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=chongwu_yuyue_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.chongwuYuyueYesnoTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`chongwuYuyue/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.chongwuYuyueCrossAddOrUpdateFlag = false;
                                        this.parent.search();
