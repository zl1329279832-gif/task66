        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="宠物编号" prop="chongwuUuidNumber">
                       <el-input v-model="ruleForm.chongwuUuidNumber"
                                 placeholder="宠物编号" clearable  :readonly="ro.chongwuUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="宠物地点" prop="chongwuAddress">
                       <el-input v-model="ruleForm.chongwuAddress"
                                 placeholder="宠物地点" clearable  :readonly="ro.chongwuAddress"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.chongwuContent"  label="宠物介绍" prop="chongwuContent">
    ...
    export default {
        data() {
            return {
                ...
                ruleForm: {
                    chongwuName: '',
                    chongwuUuidNumber: new Date().getTime(),
                    chongwuPhoto: '',
                    chongwuAddress: '',
                    zanNumber: '',
                    caiNumber: '',
                ...
                rules: {
                   ...
                   chongwuAddress: [
                              { required: true, message: '宠物地点不能为空', trigger: 'blur' },
                          ],
                   zanNumber: [
